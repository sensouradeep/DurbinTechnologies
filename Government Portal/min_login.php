...
if(!empty($_POST['save'])){
	...
	$error="";
	$success="";
	$query="select * from mlogin where username='$uname' and password='$pass'";
...
<section class="my-5">
	<div class="py-5">
		<h1 class="text-center">Ministers are requested to login below</h1>
	</div>
</section>
<section class="my-5">
<div class="logincontainer">
	...
	<div class="w-50 m-auto">
		<form action="min_report.php" method="post">
